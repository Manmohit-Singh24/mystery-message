  ...
  return isLoadingUser ? (
    ...
    <>
      <div className="text-center">
        <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl mb-2">Reset Password</h1>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
        ...
        <Button disabled={isSubmitting}>{isSubmitting && <Spinner />} Continue</Button>
      </form>
    </>
  );
}
