...
import { main, container, tertiary, secondary, paragraph, footer } from "./emailStyles";
...
export const LoginAlert = ({ name, loginTime, deviceInfo }: LoginAlertEmailProps) => {
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          {/* Instructions */}
          <Text style={paragraph}>We noticed a new login to your {appName} account:</Text>
