...
import { main, container, tertiary, secondary, paragraph, footer, button } from "./emailStyles";
...
export const ReWelcomeTemplate = ({ name, loginTime, deviceInfo }: ReWelcomeEmailProps) => {
