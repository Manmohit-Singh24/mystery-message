...
export const VerificationEmailTemplate = ({ name, validationCode }: VerificationEmailProps) => (
  <Html>
    <Head />
    <Body style={main}>
      <Container style={container}>
        ...
        {/* Instructions */}
        <Text style={paragraph}>
          Enter the following code to verify your email and activate your Mystery Message account.
        </Text>
