  ...
  return isLoadingUser ? (
    ...
    <>
      <Card className="w-full gap-1 shadow-sm border-none">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-1">Your anonymous message link:</p>
          ...
          <form onSubmit={form.handleSubmit(handleAcceptMsgSwitchToggle)} className="mt-4">
            <Controller
              ...
              render={({ field }) => (
                <>
                  <Switch
                    ...
                    type="submit"
                  />
                  <span className="ml-2">Accept Messages: {isAcceptingMessage ? "On" : "Off"}</span>
                </>
              )}
            />
          </form>
