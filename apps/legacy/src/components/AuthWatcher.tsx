...
const authPaths = ["", "login", "register", "forgot-password", "reset-password", "activate"];
...
export function UnAuthRouting({ pathname, router }: { pathname: string; router: any }) {
  const { setIsLoadingUser } = useUserStore();
...
export function UserFetcher({ pathname, router }: { pathname: string; router: any }) {
